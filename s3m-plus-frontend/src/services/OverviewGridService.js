import OVERVIEW_GRID_API from "../constants/overview_grid";
import authService from "./AuthService";
import commonService from "./CommonService";
import CONS from './../constants/constant';

class OverViewGridService {
    #type;
    #commonService;
    #authService;
    ...
    getPower = async (customerId, projectId, keyword) => {
        let url = OVERVIEW_GRID_API.OVERVIEW.GET_POWER + customerId + "/" + projectId + "?keyword=" + keyword;
    ...
    getDataChart = async (customerId, projectId, fromDate, toDate) => {
        let url = OVERVIEW_GRID_API.OVERVIEW.GET_DATA_CHART + customerId + "/" + projectId;
        let type = this.#type.GET;
    ...
    getTotalEnergy = async (customerId, projectId) => {
        let url = OVERVIEW_GRID_API.OVERVIEW.GET_TOTALENERGY + customerId + "/" + projectId;
        let type = this.#type.GET;
        return await this.#commonService.sendRequest(type, url, null);
    }

    exportExcel = async (customerId, projectId, fromDate, toDate, userName) => {
        let url = OVERVIEW_GRID_API.OVERVIEW.EXPORT_EXCEL + customerId + "/" + projectId;
...
export default new OverViewGridService();