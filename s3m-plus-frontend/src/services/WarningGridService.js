...
import WARNING_API from "../constants/warning_grid_api";
import CONS from "../constants/constant";

class WarningGridService {
    #type;
    #commonService
    ...
    showDataWarningByDevice = async (warningType, fromDate, toDate, projectId, customerId, deviceId, page) => {
...
export default new WarningGridService();