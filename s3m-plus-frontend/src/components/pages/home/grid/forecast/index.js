...
const Forecast = ({ projectInfo }) => {
    ...
    const getForecast = async () => {
        let res = await ForecastSolarService.getForecast(param.customerId, param.projectId, 5);
        if (res.status === 200) {
    ...
    const getForecastss = async () => {
        let res = await ForecastSolarService.getForecasts(param.customerId, param.projectId, 5, page);
        if (res.status === 200) {
                ...
                <table className="table tbl-overview table-bordered mt-2">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" name="a1" value={formik.values.a1 === null ? 0 : formik.values.a1} disabled={role === "ROLE_ADMIN" ? false : true} onChange={formik.handleChange} className="form-control" />
                            </td>
                            <td>
                                <input type="number" name="a2" value={formik.values.a2 === null ? 0 : formik.values.a2} disabled={role === "ROLE_ADMIN" ? false : true} onChange={formik.handleChange} className="form-control" />
                            </td>
                            <td>
                                <input type="number" name="a3" value={formik.values.a3 === null ? 0 : formik.values.a3} disabled={role === "ROLE_ADMIN" ? false : true} onChange={formik.handleChange} className="form-control" />
                            </td>
                            <td>
                                <input type="number" name="a4" value={formik.values.a4 === null ? 0 : formik.values.a4} disabled={role === "ROLE_ADMIN" ? false : true} onChange={formik.handleChange} className="form-control" />
                            </td>
                            <td>
                                <input type="number" name="a5" value={formik.values.a5 === null ? 0 : formik.values.a5} disabled={role === "ROLE_ADMIN" ? false : true} onChange={formik.handleChange} className="form-control" />
                            </td>
                            <td>
                                <input type="number" name="a6" value={formik.values.a6 === null ? 0 : formik.values.a6} disabled={role === "ROLE_ADMIN" ? false : true} onChange={formik.handleChange} className="form-control" />
                            </td>
                            <td>
                                <input type="number" name="a7" value={formik.values.a7 === null ? 0 : formik.values.a7} disabled={role === "ROLE_ADMIN" ? false : true} onChange={formik.handleChange} className="form-control" />
                            </td>
                            <td>
                                <input type="number" name="a8" value={formik.values.a8 === null ? 0 : formik.values.a8} disabled={role === "ROLE_ADMIN" ? false : true} onChange={formik.handleChange} className="form-control" />
                            </td>
                            <td>
                                <input type="number" name="a9" value={formik.values.a9 === null ? 0 : formik.values.a9} disabled={role === "ROLE_ADMIN" ? false : true} onChange={formik.handleChange} className="form-control" />
                            </td>
                        </tr>
                        {(role === "ROLE_ADMIN") &&
                            <tr>
