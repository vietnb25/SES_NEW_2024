...
const PowerCircuit = () => {
    ...
    const drawChart = (dataChart) => {
        ...
        am5.ready(function () {
            ...
            let xRenderer = am5xy.AxisRendererX.new(root, { minGridDistance: 10,strokeWidth: 3 });
            ...
            createSeries("Dòng điện pha B", "ib", "triangle");
            createSeries("Dòng điện pha C", "ic", "square");
