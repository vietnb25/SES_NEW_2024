...
const ElectricalPower = () => {
    ...
    const getOperationInformation = async () => {
        ...
        let res = await OperationInformationService.getDataChart(param.deviceId, param.fromDate, null, param.pqsViewType, param.chartType);
    ...
    const drawChart = (dataChart) => {
        ...
        am5.ready(function () {
            ...
            makeSeries("Giờ thấp điểm", "low");
            makeSeries("Giờ bình thường", "normal");
            makeSeries("Giờ cao điểm", "high");
    ...
    }, [param.deviceId, param.fromDate, param.pqsViewType, param.chartType])
    return (
        <>
