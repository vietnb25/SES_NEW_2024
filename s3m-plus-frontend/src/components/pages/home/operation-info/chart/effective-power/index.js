...
const EffectivePower = () => {
    ...
    const drawChart = (dataChart) => {
        ...
        am5.ready(function () {
            ...
            yAxis.children.moveValue(am5.Label.new(root, { text: "Công suất (W)", rotation: -90, y: am5.p50, centerX: am5.p50, fontWeight: "bold" }), 0);
            ...
            createSeries("Công suất pha B", "pb", "triangle");
            createSeries("Công suất pha C", "pc", "square");
