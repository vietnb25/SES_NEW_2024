...
const Instant = () => {
    ...
    const getInstantOperationInformation = async () => {
        let res = await OperationInformationService.getInstantOperationInformation(param.deviceId);
        if (res.status === 200) {
    ...
    const getInstantPowerQuality = async () => {
        let res = await OperationInformationService.getInstantPowerQuality(param.deviceId);
        if (res.status === 200) {
        ...
        <>
            ...
            <table className="table tbl-overview tbl-tsd">
                ...
                <tbody>
                    <tr>
                        ...
                        <td className="text-center" rowSpan={3}>-</td>
                        <td className="text-center" rowSpan={3}>{instant?.ep != null ? instant?.ep : "-" }</td>
                    </tr>
                    <tr>
            ...
            <table className="table tbl-overview tbl-tsnd">
                ...
                <tbody>
                    ...
                    <tr>
                        <td className="text-center">C</td>
                        <td className="text-center">{instant?.t3 != null ? instant?.t1 : "-" }</td>
                        <td className="text-center">-</td>
                        <td className="text-center">-</td>
                    </tr>
                </tbody>
            ...
            <table className="table tbl-overview tbl-tsd mt-3">
                <thead>
                    <tr>
                        <th colSpan="32" className="tbl-title">Thông số chất lượng điện năng [%]</th>
                    </tr>
                </thead>
            </table>
            <table className="table tbl-overview tbl-tsd">
