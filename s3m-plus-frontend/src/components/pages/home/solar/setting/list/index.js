...
const ListSetting = ({ permissionActions, projectInfo }) => {
    ...
    const listSetting = async () => {
        let res = await SettingService.listSetting(param.customerId, param.projectId, CONS.SYSTEM_TYPE.PV);
                                    ...
                                    <td className="text-center">
                                        {
                                            ...
                                            <Link className="button-icon" to={`/home/solar/${param.customerId}/${param.projectId}/setting/${setting.settingId}/edit`} title="Chỉnh sửa">
