...
const EffectivePower = () => {
    ...
    const drawChart = (dataChart, typeValue) => {
        ...
        am5.ready(function () {
            ...
            createSeries("Công suất pha A", "pfa", "circle");
            createSeries("Công suất pha B", "pfb", "circle");
            createSeries("Công suất pha C", "pfc", "circle");
            createSeries("Công suất tổng AC", "ptotal", "circle");
            createSeries("Công suất tổng DC", "pdc", "circle");
