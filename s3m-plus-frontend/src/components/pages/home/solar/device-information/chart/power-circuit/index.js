...
const PowerCircuit = () => {
    ...
    const drawChart = (dataChart) => {
        ...
        am5.ready(function () {
            ...
            let xRenderer = am5xy.AxisRendererX.new(root, { minGridDistance: 80, strokeWidth: 3 });
            ...
            if (parseInt(param.deviceType) === CONS.DEVICE_TYPE_PV.INVERTER) {
                createSeries("Dòng điện pha A", "ia", "circle");
                createSeries("Dòng điện pha B", "ib", "circle");
                createSeries("Dòng điện pha C", "ic", "circle");
                createSeries("Dòng điện DC", "idc", "circle");
            }
            if (parseInt(param.deviceType) === CONS.DEVICE_TYPE_PV.COMBINER) {
                createSeries("Dòng điện DC", "idcCombiner", "circle");
            }
            if (parseInt(param.deviceType) === CONS.DEVICE_TYPE_PV.STRING) {
                createSeries("Dòng điện DC", "idcStr", "circle");
            }
            if (parseInt(param.deviceType) === CONS.DEVICE_TYPE_PV.PANEL) {
                createSeries("Dòng điện DC", "i", "circle");
            }
