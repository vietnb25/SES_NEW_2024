...
import Meter from "../list/meter";
import Inverter from "../list/inverter";
import TempHumidity from "../list/temp-humidity";
import Status from "../list/status";
import PD_HTR02 from "../list/pd-htr02";
import PD_AMS01 from "../list/pd-ams01";
import Pressure from "../list/pressure-sensor";
import Flow from "../list/flow-sensor";
...
const ListSetting = (props) => {
    ...
    return (
        ...
        <div>
            ...
            <div className="div-setting-warning p-2">

                {loadding == false ? <div className="frame-table-setting" hidden={selectedDevices.length <= 0}>
                    <div className="zone-layout">
                        {
                            deviceTypeId == 1 && 
                            <Meter deviceIds={deviceIds}/>
                        }
                        {
                            deviceTypeId == 2 && 
                            <Inverter deviceIds={deviceIds}/>
                        }
                        {
                            deviceTypeId == 3 && 
                            <TempHumidity deviceIds={deviceIds}/>
                        }
                        {
                            deviceTypeId == 4 && 
                            <Status deviceIds={deviceIds}/>
                        }
                        {
                            deviceTypeId == 5 && 
                            <PD_HTR02 deviceIds={deviceIds}/>
                        }
                        {
                            deviceTypeId == 6 && 
                            <PD_AMS01 deviceIds={deviceIds}/>
                        }
                         {
                            deviceTypeId == 7 && 
                            <Pressure deviceIds={deviceIds}/>
                        }
                        {
                            deviceTypeId == 10 && 
                            <Flow deviceIds={deviceIds}/>
                        }
                    </div>
                </div>
                    :
