...
import "../select-device-sankey-2/select-device-sankey-2.css"
...
function SelectDeviceSankey2(props) {
    ...
    const [selectedDevicesClass2, setSelectedDevicesClass2] = useState([]);
    ...
    const sendData = (selectDeviceId, items, selectedDevicesClass2) => {
        props.parentCallback(selectDeviceId, items, selectedDevicesClass2)

    }

    const sendDataDeviceTotalAndDeviceClass2 = () => {
        let arr = [];
    ...
    const getListDevice = async (type, area) => {
        ...
        if (selectedDevicesClass2 != "" || selectedDevicesClass2 != undefined) {
            const filteredList3 = filteredList2.filter(
                (fullItem) => !selectedDevicesClass2.some((removeItem) => removeItem.deviceId === fullItem.deviceId)
            );
    ...
    const onSelectDevice = (item) => {
        ...
        if (ck === false) {
            ...
            setSelectedDevicesClass2(Array.from(new Set([...selectedDevicesClass2, item])));
    ...
    return (
        <>
            {/* Modal */}
            <button type="button" className={'btn btn-select-device-sankey2'} data-toggle="modal" data-target="#exampleModalCenter1" onClick={() => {
                getListDevice()
            }
            } style={props.style} >
                {props.titleName}
                ...
                <div id={"select-device-dialog"} className="modal-dialog modal-dialog-centered" role="document">
                    <div id={"select-device-content"} className="modal-content modal-select-content" >
                        <div className='box-select'>
                            ...
                            <div className='modal-select-body row'>
                                ...
                                <div className='body-right col-4'>
                                    ...
                                    <div className='body-content'>
                                        {props.deviceClass2?.map((item, index) => {
                                            return (
                                ...
                                <div className='body-right col-4'>
                                    <p className='body-title-1'>{t('content.home_page.device_select.device_lv2')}</p>
                                    <div className='body-content'>
                            ...
                            <div className='modal-select-footer-sankey2'>
                                <button type="button" className="btn btn-confirm" style={{ marginRight: '1.5%' }} onClick={() => sendDataDeviceTotalAndDeviceClass2(selectedDevices)}>{t('content.home_page.device_select.save_device')}</button>
                                <button type="button" className="btn btn-confirm" style={{ marginRight: '1.5%' }} data-dismiss="modal" onClick={() => sendData(selectedDevicesId, items, selectedDevicesClass2)}>{t('content.accept')}</button>
...
export default SelectDeviceSankey2;