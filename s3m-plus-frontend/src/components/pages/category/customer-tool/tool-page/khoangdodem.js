...
let KHOANGDODEM = {
    ID: "idkdd-",
    ID_CIRCLE_CONNECT: "kddc",
    ID_CONNECT_TOP_MARKER: "kddct-",
    ID_CONNECT_LEFT_MARKER: "kddcl-",
    ID_CONNECT_RIGHT_MARKER: "kddcr-",
    ID_CONNECT_BOTTOM_MARKER: "kddcb-",

    ID_STATUS_KHOANG: "iskdd-",
    ID_PATH_1_KHOANGDODEM: "ip1kdd-",
    ID_PATH_2_KHOANGDODEM: "ip2kdd-",
    ID_REMOVE: "irmkdd-",
    ID_DETAIL: "idtkdd-",
    ID_FOCUS: "ifkdd-",

    KHOANGDODEM_T_TEXT: "T (°C)",
    KHOANGDODEM_H_TEXT: "H (%)",
    KHOANGDODEM_P_TEXT: "PD",
    KHOANGDODEM_U_TEXT: "U (V)",
    KHOANGDODEM_I_TEXT: "I (A)",

    ID_KHOANG_VALUE_T: "ivtkdd-",
    ID_KHOANG_VALUE_H: "ivhkdd-",
    ID_KHOANG_VALUE_P: "ivpkdd-",
    ID_KHOANG_VALUE_U: "ivukdd-",
    ID_KHOANG_VALUE_I: "ivikdd-",
    ...
    collect: function () {
        var _tagName = document.getElementById("khoang-do-dem-tag-name").value;
        var _deviceName = document.getElementById("khoang-do-dem-device-name").value;
        var _description = document.getElementById("khoang-do-dem-description").value;
        var _deviceCaculator = Number($("input[name=khoang_do_dem_caculator]").filter(":checked").val());
    ...
    create: function () {
        var _oCard = KHOANGDODEM.collect();
        DATA.aCards.push(_oCard);
        KHOANGDODEM.draw(_oCard);
    },
    ...
    drawLoad: function (card) {
        ...
        var _gCard = g_svg.datum(card).append('g')
            .attr("id", function (d) { return (KHOANGDODEM.ID + d.id); })
        ...
        var _path1 = _gCard.datum(card).append("path")
            .attr("id", function (d) { return (KHOANGDODEM.ID_PATH_1_KHOANGDODEM + d.deviceId); })
            .attr("d", CONSTANTS.KHOANGDODEM.path1)
        ...
        var _textT = _gCard.datum(card).append("text")
            ...
            .attr("text-anchor", "middle")
            .attr("font-size", "15")
            .text(KHOANGDODEM.KHOANGDODEM_T_TEXT);
        ...
        var _textH = _gCard.datum(card).append("text")
            ...
            .attr("text-anchor", "middle")
            .attr("font-size", "15")
            .text(KHOANGDODEM.KHOANGDODEM_H_TEXT);
        ...
        var _textP = _gCard.datum(card).append("text")
            ...
            .attr("text-anchor", "middle")
            .attr("font-size", "15")
            .text(KHOANGDODEM.KHOANGDODEM_P_TEXT);
        ...
        var _textU = _gCard.datum(card).append("text")
            ...
            .attr("text-anchor", "middle")
            .attr("font-size", "15")
            .text(KHOANGDODEM.KHOANGDODEM_U_TEXT);
        ...
        var _textI = _gCard.datum(card).append("text")
            ...
            .attr("text-anchor", "middle")
            .attr("font-size", "15")
            .text(KHOANGDODEM.KHOANGDODEM_I_TEXT);
        ...
        var _valueU = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (KHOANGDODEM.ID_KHOANG_VALUE_U + d.deviceId); })
            .attr("x", "146")
            .attr("y", "131")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueI = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (KHOANGDODEM.ID_KHOANG_VALUE_I + d.deviceId); })
            .attr("x", "146")
            .attr("y", "160")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _rect = _gCard.datum(card).append("rect")
            .attr("id", function (d) { return (KHOANGDODEM.ID_FOCUS + d.id); })
            .attr("x", "-30")
            .attr("y", "-30")
            .attr("width", "238")
            .attr("height", "238")
            .attr("fill", "transparent")
            .on("click", KHOANGDODEM.detail);
    ...
    draw: function (card) {
        ...
        var _gCard = g_svg.datum(card).append('g')
            ...
            .on("click", KHOANGDODEM.select)
            .call(KHOANGDODEM.drag);
        ...
        var _cardTopMaker = _gCard.datum(card).append('circle')
            .attr("id", function (d) { return KHOANGDODEM.ID_CONNECT_TOP_MARKER + d.id; })
            .attr("class", "circle-connect")
            .attr("r", "7")
            .attr("transform", "translate(0,0)")
            .attr("cx", KHOANGDODEM.DEFAULT_WIDTH / 2)
            .attr("cy", 2)
            .attr("opacity", 0.5)
            .attr("cursor", "pointer")
            .attr("marker", KHOANGDODEM.ID_CONNECT_TOP_MARKER)
            .attr("fill", "#237ba0")
            .call(KHOANGDODEM.connect);

        var _cardLeftMaker = _gCard.datum(card).append('circle')
            .attr("id", function (d) { return KHOANGDODEM.ID_CONNECT_LEFT_MARKER + d.id; })
            .attr("class", "circle-connect")
            .attr("r", "7")
            .attr("transform", "translate(0,0)")
            .attr("cx", 2)
            .attr("cy", KHOANGDODEM.DEFAULT_HEIGHT / 2)
            .attr("opacity", 0.5)
            .attr("cursor", "pointer")
            .attr("marker", KHOANGDODEM.ID_CONNECT_LEFT_MARKER)
            .attr("fill", "#237ba0")
            .call(KHOANGDODEM.connect);

        var _cardRightMaker = _gCard.datum(card).append('circle')
            .attr("id", function (d) { return KHOANGDODEM.ID_CONNECT_RIGHT_MARKER + d.id; })
            .attr("class", "circle-connect")
            .attr("r", "7")
            .attr("transform", "translate(0,0)")
            .attr("cx", KHOANGDODEM.DEFAULT_WIDTH - 2)
            ...
            .attr("opacity", 0.5)
            .attr("cursor", "pointer")
            .attr("marker", KHOANGDODEM.ID_CONNECT_RIGHT_MARKER)
            .attr("fill", "#237ba0")
            .call(KHOANGDODEM.connect);

        var _cardBottomMaker = _gCard.datum(card).append('circle')
            .attr("id", function (d) { return KHOANGDODEM.ID_CONNECT_BOTTOM_MARKER + d.id; })
            .attr("class", "circle-connect")
            .attr("r", "7")
            .attr("transform", "translate(0,0)")
            .attr("cx", KHOANGDODEM.DEFAULT_WIDTH / 2)
            ...
            .attr("opacity", 0.5)
            .attr("cursor", "pointer")
            .attr("marker", KHOANGDODEM.ID_CONNECT_BOTTOM_MARKER)
            .attr("fill", "#237ba0")
            .call(KHOANGDODEM.connect);

        var _gX = _gCard.datum(card).append("g")
            .attr("id", function (d) { return (KHOANGDODEM.ID_REMOVE + d.id); })
            .attr("transform", "translate(-20,-40)")
            .attr("opacity", "1")
            .attr("cursor", "pointer")
            .on("click", KHOANGDODEM.delete);
    ...
    drag: d3.drag()
        .on("start", function (i, d) {
            ...
            var _oCard = KHOANGDODEM.get(d.id);
            document.getElementById("khoang-do-dem-device-name").value = _oCard.deviceName;
            document.getElementById("khoang-do-dem-tag-name").value = _oCard.tagName;
            document.getElementById("khoang-do-dem-description").value = _oCard.description;

            if (Number(_oCard.caculator) == 1) {
                document.getElementById("khoang-do-dem-caculator-1").checked = true;
            } else {
                document.getElementById("khoang-do-dem-caculator-0").checked = true;
            };
        ...
        .on("drag", function (i, d) {
            var _gCard = d3.select("g[id=" + KHOANGDODEM.ID + d.id + "]");
            var _circleTopMaker = d3.select("circle[id=" + KHOANGDODEM.ID_CONNECT_TOP_MARKER + d.id + "]");
            var _circleLeftMaker = d3.select("circle[id=" + KHOANGDODEM.ID_CONNECT_LEFT_MARKER + d.id + "]");
            var _circleRightMaker = d3.select("circle[id=" + KHOANGDODEM.ID_CONNECT_RIGHT_MARKER + d.id + "]");
            var _circleBottomMaker = d3.select("circle[id=" + KHOANGDODEM.ID_CONNECT_BOTTOM_MARKER + d.id + "]");

            d3.select(this).attr("transform", "translate(" + (d.x) + "," + (d.y) + ")");
            d.x = i.x;
            d.y = i.y;
            KHOANGDODEM.moveArrows(d.id);
            ...
            if (g_connect.cardId == "") {
                d3.selectAll("circle[id^=" + METER.ID_CIRCLE_CONNECT + "]").each(function (c) {
                    ...
                    if (_isOverlapT || _isOverlapL || _isOverlapR || _isOverlapB) {
                        ...
                        if (_isOverlapT) {
                            g_connect.circleFrom = KHOANGDODEM.ID_CONNECT_TOP_MARKER;
                        } else if (_isOverlapL) {
                            g_connect.circleFrom = KHOANGDODEM.ID_CONNECT_LEFT_MARKER;
                        } else if (_isOverlapR) {
                            g_connect.circleFrom = KHOANGDODEM.ID_CONNECT_RIGHT_MARKER;
                        } else if (_isOverlapB) {
                            g_connect.circleFrom = KHOANGDODEM.ID_CONNECT_BOTTOM_MARKER;
                        };
                    };
                });
    ...
    connect: d3.drag()
        .on("start", function (i, d) {
            ...
            var _gArrow = g_svg.datum(KHOANGDODEM.directArrow).append('g')
            ...
            var _arrowLine = _gArrow.datum(KHOANGDODEM.directArrow).append("line")
            ...
            var _arrowStartPoint = _gArrow.datum(KHOANGDODEM.directArrow).append('circle')
            ...
            var _arrowEndPoint = _gArrow.datum(KHOANGDODEM.directArrow).append('circle')
        ...
        .on("drag", function (event, d) {
            ...
            var _gArrow = d3.select("g[id=" + ARROW.ID + KHOANGDODEM.directArrow.id + "]");
            var _arrowLine = d3.select("line[id=" + ARROW.ID_LINE + KHOANGDODEM.directArrow.id + "]");
            var _arrowEndPoint = d3.select("circle[id=" + ARROW.ID_LINE_POINT_END + KHOANGDODEM.directArrow.id + "]");
        ...
        .on("end", function (i, d) {
            ...
            if (g_connect.attachFlag && g_connect.id != "") {
                ...
                KHOANGDODEM.directArrow.to = g_connect.id;
                KHOANGDODEM.directArrow.toMarker = g_connect.attachMarker;
                KHOANGDODEM.directArrow.x2 = _x;
                KHOANGDODEM.directArrow.y2 = _y;
                DATA.aArrows.push(KHOANGDODEM.directArrow);
                ARROW.update(KHOANGDODEM.directArrow.id, 1);
            } else {
                d3.select("g[id=" + ARROW.ID + KHOANGDODEM.directArrow.id + "]").remove();
            }
    ...
    remove: function (id) {
        ...
        if (!isMarker) {
            ...
            d3.select("g[id=" + KHOANGDODEM.ID + id + "]").remove();
    ...
    focus: function (id) {
        if (id != null) {
            $('circle[id^=' + KHOANGDODEM.ID_CONNECT_TOP_MARKER + id + ']').attr("opacity", 1);
            $('circle[id^=' + KHOANGDODEM.ID_CONNECT_LEFT_MARKER + id + ']').attr("opacity", 1);
            $('circle[id^=' + KHOANGDODEM.ID_CONNECT_RIGHT_MARKER + id + ']').attr("opacity", 1);
            $('circle[id^=' + KHOANGDODEM.ID_CONNECT_BOTTOM_MARKER + id + ']').attr("opacity", 1);
            $('g[id^=' + KHOANGDODEM.ID_REMOVE + id + ']').attr("opacity", 1);
        }
    },

    outFocus: function (id) {
        if (id != null) {
            $('circle[id^=' + KHOANGDODEM.ID_CONNECT_TOP_MARKER + id + ']').attr("opacity", 0);
            $('circle[id^=' + KHOANGDODEM.ID_CONNECT_LEFT_MARKER + id + ']').attr("opacity", 0);
            $('circle[id^=' + KHOANGDODEM.ID_CONNECT_RIGHT_MARKER + id + ']').attr("opacity", 0);
            $('circle[id^=' + KHOANGDODEM.ID_CONNECT_BOTTOM_MARKER + id + ']').attr("opacity", 0);
            $('g[id^=' + KHOANGDODEM.ID_REMOVE + id + ']').attr("opacity", 0)
        } else {
            $('circle[id^=' + KHOANGDODEM.ID_CONNECT_TOP_MARKER + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('circle[id^=' + KHOANGDODEM.ID_CONNECT_LEFT_MARKER + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('circle[id^=' + KHOANGDODEM.ID_CONNECT_RIGHT_MARKER + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('circle[id^=' + KHOANGDODEM.ID_CONNECT_BOTTOM_MARKER + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('g[id^=' + KHOANGDODEM.ID_REMOVE + ']').each(function () {
                $(this).attr("opacity", 0);
            });
        }
    },
    ...
    moveArrows: function (id) {
        ...
        $.each(_attachArrows, function (i, data) {
            ...
            var _gCard = d3.select("g[id=" + KHOANGDODEM.ID + id + "]");
    ...
    update: function (id) {
        var _oCurrent = KHOANGDODEM.get(id);

        if (typeof _oCurrent !== "undefined" && _oCurrent.type == "khoangdodem") {
            var _deviceCaculator = Number($("input[name=khoang_do_dem_caculator]").filter(":checked").val());
            var _tagName = document.getElementById("khoang-do-dem-tag-name").value;
            var _description = document.getElementById("khoang-do-dem-description").value;
            var _oCard = {
