...
let LABEL = {
    ...
    collect: function () {
        var _tagName = document.getElementById("label-tag-name").value;
        var _labelType = Number($("input[name=label_type]").filter(":checked").val());
        var _description = document.getElementById("label-description").value;

        var _label = {
            "id": Date.now(),
            "tagName": _tagName,
            "description": _description,
            "width": LABEL.DEFAULT_WIDTH,
    ...
    drawLoad: function (card) {
        ...
        if (card.labelType == 1) {
            var _rect = _gCard.datum(card).append("rect")
                .attr("x", "0")
                .attr("y", "0")
                .attr("width", function (d) { return LABEL.DEFAULT_WIDTH })
                .attr("height", function (d) { return LABEL.DEFAULT_HEIGHT })
                .attr("stroke-width", "3")
                .attr("stroke", "rgb(4.705882%,10.980392%,14.509804%)")
                .attr("fill", "#ffffff");

            var _gDeviceName = _gCard.datum(card).append('g')
                .attr("transform", "translate(0," + LABEL.DEFAULT_HEIGHT + ") rotate(270)");

            var _svgDeviceName = _gDeviceName.append('svg')
                .attr("width", LABEL.DEFAULT_HEIGHT);
            ...
            var _rect = _gCard.datum(card).append("rect")
                .attr("x", "0")
                .attr("y", "0")
                .attr("width", function (d) { return LABEL.DEFAULT_HEIGHT })
                .attr("height", function (d) { return LABEL.DEFAULT_WIDTH })
                .attr("stroke-width", "3")
                .attr("stroke", "rgb(4.705882%,10.980392%,14.509804%)")
                .attr("fill", "#ffffff");
    ...
    draw: function (card) {
        ...
        if (card.labelType == 1) {
            ...
            var _cardTopMaker = _gCard.datum(card).append('circle')
                .attr("id", function (d) { return LABEL.ID_CONNECT_TOP_MARKER + d.id; })
                ...
                .attr("opacity", 0)
                .attr("cursor", "pointer")
                .attr("marker", LABEL.ID_CONNECT_TOP_MARKER)
                .attr("fill", "#276cb8")
                .call(LABEL.connect);

            var _cardRightMaker = _gCard.datum(card).append('circle')
                .attr("id", function (d) { return LABEL.ID_CONNECT_RIGHT_MARKER + d.id; })
                .attr("class", "circle-connect")
                .attr("r", "7")
                .attr("transform", "translate(0,0)")
                ...
                .attr("opacity", 0)
                .attr("cursor", "pointer")
                .attr("marker", LABEL.ID_CONNECT_RIGHT_MARKER)
                .attr("fill", "#276cb8")
                .call(LABEL.connect);

            var _cardBottomMaker = _gCard.datum(card).append('circle')
                .attr("id", function (d) { return LABEL.ID_CONNECT_BOTTOM_MARKER + d.id; })
                .attr("class", "circle-connect")
                .attr("r", "7")
                .attr("transform", "translate(0,0)")
                .attr("cx", function (d) { return d.width / 2; })
                ...
                .attr("opacity", 0)
                .attr("cursor", "pointer")
                .attr("marker", LABEL.ID_CONNECT_BOTTOM_MARKER)
                .attr("fill", "#276cb8")
                .call(LABEL.connect);

            var _cardLeftMaker = _gCard.datum(card).append('circle')
                .attr("id", function (d) { return LABEL.ID_CONNECT_LEFT_MARKER + d.id; })
                .attr("class", "circle-connect")
                .attr("r", "7")
                .attr("transform", "translate(0,0)")
                .attr("cx", 0)
                ...
                .attr("opacity", 0)
                .attr("cursor", "pointer")
                .attr("marker", LABEL.ID_CONNECT_LEFT_MARKER)
                .attr("fill", "#276cb8")
                .call(LABEL.connect);

            var _gRotate = _gCard.datum(card).append('g')
                .attr("id", function (d) { return (LABEL.ID_ROTATE + d.id); })
                .attr("transform", "translate(70," + LABEL.DEFAULT_HEIGHT + ")")
                .attr("class", "rotate")
                .attr("opacity", "0")
                .on("click", LABEL.rotate);
            ...
            var _gX = _gCard.datum(card).append("g")
                .attr("id", function (d) { return (LABEL.ID_REMOVE + d.id); })
                .attr("transform", "translate(-20 , -40)")
                .attr("opacity", "0")
                .attr("cursor", "pointer")
                .on("click", LABEL.delete);
            ...
            var _cardTopMaker = _gCard.datum(card).append('circle')
                ...
                .attr("r", "7")
                .attr("transform", "translate(0,0)")
                .attr("cx", function (d) { return d.height / 2; })
                .attr("cy", 0)
                .attr("opacity", 0)
                .attr("cursor", "pointer")
                .attr("marker", LABEL.ID_CONNECT_TOP_MARKER)
            ...
            var _cardRightMaker = _gCard.datum(card).append('circle')
                ...
                .attr("r", "7")
                .attr("transform", "translate(0,0)")
                .attr("cx", function (d) { return d.height; })
            ...
            var _cardBottomMaker = _gCard.datum(card).append('circle')
                ...
                .attr("transform", "translate(0,0)")
                .attr("cx", function (d) { return d.height / 2; })
                .attr("cy", function (d) { return d.width; })
                .attr("opacity", 0)
                .attr("cursor", "pointer")
                .attr("marker", LABEL.ID_CONNECT_BOTTOM_MARKER)
                .attr("fill", "#276cb8");
            ...
            var _gRotate = _gCard.datum(card).append('g')
                .attr("id", function (d) { return (LABEL.ID_ROTATE + d.id); })
                .attr("transform", "translate(" + LABEL.DEFAULT_HEIGHT + ",70)")
                .attr("class", "rotate")
                .attr("opacity", "0")
                .on("click", LABEL.rotate);
    ...
    drag: d3.drag()
        .on("start", function (i, d) {
            ...
            var _oCard = LABEL.get(d.id);
            document.getElementById("label-tag-name").value = _oCard.tagName;
            document.getElementById("label-description").value = _oCard.description;
        ...
        .on("drag", function (i, d) {
            var _gCard = d3.select("g[id=" + LABEL.ID + d.id + "]");
            var _circleTopMaker = d3.select("circle[id=" + LABEL.ID_CONNECT_TOP_MARKER + d.id + "]");
            var _circleBottomMaker = d3.select("circle[id=" + LABEL.ID_CONNECT_BOTTOM_MARKER + d.id + "]");
            var _circleLeftMaker = d3.select("circle[id=" + LABEL.ID_CONNECT_LEFT_MARKER + d.id + "]");
            var _circleRightMaker = d3.select("circle[id=" + LABEL.ID_CONNECT_RIGHT_MARKER + d.id + "]");

            d3.select(this).attr("transform", "translate(" + (d.x) + "," + (d.y) + ")");
            d.x = i.x;
            d.y = i.y;
            LABEL.moveArrows(d.id);
            ...
            if (g_connect.cardId == "") {
                d3.selectAll("circle[id^=" + METER.ID_CIRCLE_CONNECT + "]").each(function (c) {
                    ...
                    if (_isOverlapT || _isOverlapB || _isOverlapL || _isOverlapR) {
                        ...
                        if (_isOverlapT) {
                            g_connect.circleFrom = LABEL.ID_CONNECT_TOP_MARKER;
                        } else if (_isOverlapB) {
                            g_connect.circleFrom = LABEL.ID_CONNECT_BOTTOM_MARKER;
                        } else if (_isOverlapL) {
                            g_connect.circleFrom = LABEL.ID_CONNECT_LEFT_MARKER;
                        } else if (_isOverlapR) {
                            g_connect.circleFrom = LABEL.ID_CONNECT_RIGHT_MARKER;
                        }
                    };
                });
    ...
    connect: d3.drag()
        .on("start", function (i, d) {
            ...
            var _gArrow = g_svg.datum(LABEL.directArrow).append('g')
            ...
            var _arrowLine = _gArrow.datum(LABEL.directArrow).append("line")
            ...
            var _arrowStartPoint = _gArrow.datum(LABEL.directArrow).append('circle')
            ...
            var _arrowEndPoint = _gArrow.datum(LABEL.directArrow).append('circle')
        ...
        .on("drag", function (event, d) {
            ...
            var _gArrow = d3.select("g[id=" + ARROW.ID + LABEL.directArrow.id + "]");
            var _arrowLine = d3.select("line[id=" + ARROW.ID_LINE + LABEL.directArrow.id + "]");
            var _arrowEndPoint = d3.select("circle[id=" + ARROW.ID_LINE_POINT_END + LABEL.directArrow.id + "]");
        ...
        .on("end", function (i, d) {
            ...
            if (g_connect.attachFlag && g_connect.id != "") {
                ...
                LABEL.directArrow.to = g_connect.id;
                LABEL.directArrow.toMarker = g_connect.attachMarker;
                LABEL.directArrow.x2 = _x;
                LABEL.directArrow.y2 = _y;
                DATA.aArrows.push(LABEL.directArrow);
                ARROW.update(LABEL.directArrow.id, 1);
            } else {
                d3.select("g[id=" + ARROW.ID + LABEL.directArrow.id + "]").remove();
            }
    ...
    remove: function (id) {
        ...
        if (!isMarker) {
            d3.select("g[id=" + LABEL.ID + id + "]").remove();
    ...
    focus: function (id) {
        if (id != null) {
            $('circle[id^=' + LABEL.ID_CONNECT_TOP_MARKER + id + ']').attr("opacity", 1);
            $('circle[id^=' + LABEL.ID_CONNECT_BOTTOM_MARKER + id + ']').attr("opacity", 1);
            $('circle[id^=' + LABEL.ID_CONNECT_LEFT_MARKER + id + ']').attr("opacity", 1);
            $('circle[id^=' + LABEL.ID_CONNECT_RIGHT_MARKER + id + ']').attr("opacity", 1);
            $('g[id^=' + LABEL.ID_ROTATE + id + ']').attr("opacity", 1);
            $('g[id^=' + LABEL.ID_REMOVE + id + ']').attr("opacity", 1);
        }
    },

    outFocus: function (id) {
        if (id != null) {
            $('circle[id^=' + LABEL.ID_CONNECT_TOP_MARKER + id + ']').attr("opacity", 0);
            $('circle[id^=' + LABEL.ID_CONNECT_BOTTOM_MARKER + id + ']').attr("opacity", 0);
            $('circle[id^=' + LABEL.ID_CONNECT_LEFT_MARKER + id + ']').attr("opacity", 0);
            $('circle[id^=' + LABEL.ID_CONNECT_RIGHT_MARKER + id + ']').attr("opacity", 0);
            $('g[id^=' + LABEL.ID_ROTATE + id + ']').attr("opacity", 0);
            $('g[id^=' + LABEL.ID_REMOVE + id + ']').attr("opacity", 0);
        } else {
            $('circle[id^=' + LABEL.ID_CONNECT_TOP_MARKER + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('circle[id^=' + LABEL.ID_CONNECT_BOTTOM_MARKER + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('circle[id^=' + LABEL.ID_CONNECT_LEFT_MARKER + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('circle[id^=' + LABEL.ID_CONNECT_RIGHT_MARKER + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('g[id^=' + LABEL.ID_ROTATE + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('g[id^=' + LABEL.ID_REMOVE + ']').each(function () {
                $(this).attr("opacity", 0);
            });
        }
    },
    ...
    moveArrows: function (id) {
        ...
        $.each(_attachArrows, function (i, data) {
            ...
            var _gCard = d3.select("g[id=" + LABEL.ID + id + "]");
    ...
    update: function (id) {
        var _oCurrent = LABEL.get(id);

        if (typeof _oCurrent !== "undefined" && _oCurrent.type == "label") {
            var _tagName = document.getElementById("label-tag-name").value;
            var _labelType = $("input[name=label_type]").filter(":checked").val();
            var _description = document.getElementById("label-description").value;
            var _oCard = {};
            _oCard = {
                "id": _oCurrent.id,
    ...
    rotate: function (e, d) {
        ...
        if (!isMarker) {
            ...
            d3.select("g[id=" + LABEL.ID + d.id + "]").remove();
