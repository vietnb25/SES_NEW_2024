...
let COMBINER = {
    ID: "idcbn-",
    ID_CIRCLE_CONNECT: "cbnc",
    ID_CONNECT_TOP_MARKER: "cbnct-",
    ID_CONNECT_LEFT_MARKER: "cbncl-",
    ID_CONNECT_RIGHT_MARKER: "cbncr-",
    ID_CONNECT_BOTTOM_MARKER: "cbncb-",
    ID_STATUS_COMBINER: "iscbn-",
    ID_PATH_COMBINER: "ipcbn-",
    ID_REMOVE: "irmcbn-",
    ID_DETAIL: "idtcbn-",
    ID_FOCUS: "ifcbn-",
    ...
    COMBINER_U_TEXT: "U (V)",
    COMBINER_I_TEXT: "I (A)",
    COMBINER_P_TEXT: "P (kW)",

    ID_COMBINER_VALUE_U: "ivucbn-",
    ID_COMBINER_VALUE_I: "ivicbn-",
    ID_COMBINER_VALUE_P: "ivpcbn-",

    directArrow: {},

    collect: function () {
        var _tagName = document.getElementById("combiner-tag-name").value;
        var _description = document.getElementById("combiner-description").value;
        var _deviceCaculator = Number($("input[name=combiner_caculator]").filter(":checked").val());
    ...
    create: function () {
        var _oCard = COMBINER.collect();
        DATA.aCards.push(_oCard);
        COMBINER.draw(_oCard);
    },
    ...
    drawLoad: function (card) {
        ...
        var _gCard = g_svg.datum(card).append('g')
            .attr("id", function (d) { return (COMBINER.ID + d.id); })
        ...
        var _path1 = _gCard.datum(card).append("path")
            .attr("id", function (d) { return (COMBINER.ID_PATH_COMBINER + d.deviceId); })
            .attr("d", CONSTANTS.COMBINER_SYMBOL.path1)
        ...
        var _statusPath = _gCard.datum(card).append("path")
            .attr("id", function (d) { return (COMBINER.ID_STATUS_COMBINER + d.deviceId); })
            .attr("d", "")
        ...
        var _gTagName = _gCard.datum(card).append('g')
            .attr("transform", "translate(-50,130) rotate(270)");
        ...
        var _valueU = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (COMBINER.ID_COMBINER_VALUE_U + d.deviceId); })
            .attr("x", "75")
            .attr("y", "30")
            .attr("fill", "black")
            .attr("font-size", "12")
        ...
        var _valueI = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (COMBINER.ID_COMBINER_VALUE_I + d.deviceId); })
            .attr("x", "75")
            .attr("y", "48")
            .attr("fill", "black")
            .attr("font-size", "12")
        ...
        var _valueP = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (COMBINER.ID_COMBINER_VALUE_P + d.deviceId); })
            .attr("x", "75")
            .attr("y", "67")
            .attr("fill", "black")
            .attr("font-size", "12")
        ...
        var _rect = _gCard.datum(card).append("rect")
            .attr("id", function (d) { return (COMBINER.ID_FOCUS + d.id); })
            .attr("x", "-20")
            .attr("y", "-20")
            .attr("width", "250")
            .attr("height", "120")
    ...
    draw: function (card) {
        ...
        var _cardTopMaker = _gCard.datum(card).append('circle')
            .attr("id", function (d) { return COMBINER.ID_CONNECT_TOP_MARKER + d.id; })
            ...
            .attr("opacity", 0)
            .attr("cursor", "pointer")
            .attr("marker", COMBINER.ID_CONNECT_TOP_MARKER)
            .attr("fill", "#237ba0")
            .call(COMBINER.connect);

        var _cardLeftMaker = _gCard.datum(card).append('circle')
            .attr("id", function (d) { return COMBINER.ID_CONNECT_LEFT_MARKER + d.id; })
            .attr("class", "circle-connect")
            .attr("r", "7")
            .attr("transform", "translate(0,0)")
            .attr("cx", 1.5)
            ...
            .attr("opacity", 0)
            .attr("cursor", "pointer")
            .attr("marker", COMBINER.ID_CONNECT_LEFT_MARKER)
            .attr("fill", "#237ba0")
            .call(COMBINER.connect);

        var _cardRightMaker = _gCard.datum(card).append('circle')
            .attr("id", function (d) { return COMBINER.ID_CONNECT_RIGHT_MARKER + d.id; })
            .attr("class", "circle-connect")
            .attr("r", "7")
            .attr("transform", "translate(0,0)")
            .attr("cx", 54.5)
            ...
            .attr("opacity", 0)
            .attr("cursor", "pointer")
            .attr("marker", COMBINER.ID_CONNECT_RIGHT_MARKER)
            .attr("fill", "#237ba0")
            .call(COMBINER.connect);

        var _cardBottomMaker = _gCard.datum(card).append('circle')
            .attr("id", function (d) { return COMBINER.ID_CONNECT_BOTTOM_MARKER + d.id; })
            .attr("class", "circle-connect")
            .attr("r", "7")
            .attr("transform", "translate(0,0)")
            .attr("cx", 28.5)
            ...
            .attr("opacity", 0)
            .attr("cursor", "pointer")
            .attr("marker", COMBINER.ID_CONNECT_BOTTOM_MARKER)
            .attr("fill", "#237ba0")
            .call(COMBINER.connect);

        var _gX = _gCard.datum(card).append("g")
            .attr("id", function (d) { return (COMBINER.ID_REMOVE + d.id); })
            .attr("transform", "translate(-20,-40)")
            .attr("opacity", "0")
            .attr("cursor", "pointer")
            .on("click", COMBINER.delete);
    ...
    drag: d3.drag()
        .on("start", function (i, d) {
            ...
            var selectElement = document.querySelectorAll('[id=combinerIds]');
            ...
            if (typeof deviceIdOption === "undefined" && deviceIdOption != "") {
                $("#combinerIds").append(new Option(_oCard.deviceName, _oCard.deviceId));
            }
            document.getElementById("combinerIds").value = _oCard.deviceId;

            if (Number(_oCard.caculator) == 1) {
                document.getElementById("combiner-caculator-1").checked = true;
            } else {
                document.getElementById("combiner-caculator-0").checked = true;
            };
        ...
        .on("drag", function (i, d) {
            var _gCard = d3.select("g[id=" + COMBINER.ID + d.id + "]");
            var _circleTopMaker = d3.select("circle[id=" + COMBINER.ID_CONNECT_TOP_MARKER + d.id + "]");
            var _circleLeftMaker = d3.select("circle[id=" + COMBINER.ID_CONNECT_LEFT_MARKER + d.id + "]");
            var _circleRightMaker = d3.select("circle[id=" + COMBINER.ID_CONNECT_RIGHT_MARKER + d.id + "]");
            var _circleBottomMaker = d3.select("circle[id=" + COMBINER.ID_CONNECT_BOTTOM_MARKER + d.id + "]");

            d3.select(this).attr("transform", "translate(" + (d.x) + "," + (d.y) + ")");
            d.x = i.x;
            d.y = i.y;
            COMBINER.moveArrows(d.id);
            ...
            if (g_connect.cardId == "") {
                d3.selectAll("circle[id^=" + METER.ID_CIRCLE_CONNECT + "]").each(function (c) {
                    ...
                    if (_isOverlapT || _isOverlapL || _isOverlapR || _isOverlapB) {
                        ...
                        if (_isOverlapT) {
                            g_connect.circleFrom = COMBINER.ID_CONNECT_TOP_MARKER;
                        } else if (_isOverlapL) {
                            g_connect.circleFrom = COMBINER.ID_CONNECT_LEFT_MARKER;
                        } else if (_isOverlapR) {
                            g_connect.circleFrom = COMBINER.ID_CONNECT_RIGHT_MARKER;
                        } else if (_isOverlapB) {
                            g_connect.circleFrom = COMBINER.ID_CONNECT_BOTTOM_MARKER;
                        };
                    };
                });
    ...
    connect: d3.drag()
        .on("start", function (i, d) {
            ...
            var _gArrow = g_svg.datum(COMBINER.directArrow).append('g')
            ...
            var _arrowLine = _gArrow.datum(COMBINER.directArrow).append("line")
            ...
            var _arrowStartPoint = _gArrow.datum(COMBINER.directArrow).append('circle')
            ...
            var _arrowEndPoint = _gArrow.datum(COMBINER.directArrow).append('circle')
        ...
        .on("drag", function (event, d) {
            ...
            var _gArrow = d3.select("g[id=" + ARROW.ID + COMBINER.directArrow.id + "]");
            var _arrowLine = d3.select("line[id=" + ARROW.ID_LINE + COMBINER.directArrow.id + "]");
            var _arrowEndPoint = d3.select("circle[id=" + ARROW.ID_LINE_POINT_END + COMBINER.directArrow.id + "]");
        ...
        .on("end", function (i, d) {
            ...
            if (g_connect.attachFlag && g_connect.id != "") {
                ...
                COMBINER.directArrow.to = g_connect.id;
                COMBINER.directArrow.toMarker = g_connect.attachMarker;
                COMBINER.directArrow.x2 = _x;
                COMBINER.directArrow.y2 = _y;
                DATA.aArrows.push(COMBINER.directArrow);
                ARROW.update(COMBINER.directArrow.id, 1);
            } else {
                d3.select("g[id=" + ARROW.ID + COMBINER.directArrow.id + "]").remove();
            }
    ...
    remove: function (id) {
        ...
        if (!isMarker) {
            d3.select("g[id=" + COMBINER.ID + id + "]").remove();
    ...
    focus: function (id) {
        if (id != null) {
            $('circle[id^=' + COMBINER.ID_CONNECT_TOP_MARKER + id + ']').attr("opacity", 1);
            $('circle[id^=' + COMBINER.ID_CONNECT_LEFT_MARKER + id + ']').attr("opacity", 1);
            $('circle[id^=' + COMBINER.ID_CONNECT_RIGHT_MARKER + id + ']').attr("opacity", 1);
            $('circle[id^=' + COMBINER.ID_CONNECT_BOTTOM_MARKER + id + ']').attr("opacity", 1);
            $('g[id^=' + COMBINER.ID_REMOVE + id + ']').attr("opacity", 1);
        }
    },

    outFocus: function (id) {
        if (id != null) {
            $('circle[id^=' + COMBINER.ID_CONNECT_TOP_MARKER + id + ']').attr("opacity", 0);
            $('circle[id^=' + COMBINER.ID_CONNECT_LEFT_MARKER + id + ']').attr("opacity", 0);
            $('circle[id^=' + COMBINER.ID_CONNECT_RIGHT_MARKER + id + ']').attr("opacity", 0);
            $('circle[id^=' + COMBINER.ID_CONNECT_BOTTOM_MARKER + id + ']').attr("opacity", 0);
            $('g[id^=' + COMBINER.ID_REMOVE + id + ']').attr("opacity", 0)
        } else {
            $('circle[id^=' + COMBINER.ID_CONNECT_TOP_MARKER + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('circle[id^=' + COMBINER.ID_CONNECT_LEFT_MARKER + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('circle[id^=' + COMBINER.ID_CONNECT_RIGHT_MARKER + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('circle[id^=' + COMBINER.ID_CONNECT_BOTTOM_MARKER + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('g[id^=' + COMBINER.ID_REMOVE + ']').each(function () {
                $(this).attr("opacity", 0);
            });
        }
    },
    ...
    moveArrows: function (id) {
        ...
        $.each(_attachArrows, function (i, data) {
            ...
            var _gCard = d3.select("g[id=" + COMBINER.ID + id + "]");
    ...
    update: function (id) {
        if (id != 0) {
            ...
            var _oCurrent = COMBINER.get(id);
            var deviceSelect = document.getElementById("combinerIds");
            var _deviceId = deviceSelect.value;
            var _deviceName = "";
            if (typeof _oCurrent !== "undefined" && _oCurrent.type == "combiner") {
