...
let LABEL2 = {
    ...
    collect: function (type) {
        var _description = document.getElementById("label" + type + "-description").value;

        var _label = {
            "id": Date.now(),
            "description": _description,
            "width": LABEL2.DEFAULT_WIDTH,
            "height": LABEL2.DEFAULT_HEIGHT,
            "x": LABEL2.DEFAULT_X,
            "y": LABEL2.DEFAULT_Y,
            "typeId": type,
            "type": "label" + type,
    ...
    drawLoad: function (card) {
        ...
        var _gCard = g_svg.datum(card).append('g')
            .attr("id", function (d) { return (LABEL2.ID + d.id); })
            ...
            if (card.typeId == 2) {
                var _rect = _gCard.datum(card).append("image")
                    .attr("href", "/resources/image/components/label_02/label_02.svg")
                    .attr("width", LABEL2.DEFAULT_WIDTH)
                    .attr("height", LABEL2.DEFAULT_HEIGHT)
            } else if (card.typeId == 3) {
                var _rect = _gCard.datum(card).append("image")
                    .attr("href", "/resources/image/components/label_02/label_03.svg")
                    .attr("width", LABEL2.DEFAULT_WIDTH)
                    .attr("height", LABEL2.DEFAULT_HEIGHT)
            } else if (card.typeId == 4) {
                var _rect = _gCard.datum(card).append("image")
                    .attr("href", "/resources/image/components/label_02/label_04.svg")
                    .attr("width", LABEL2.DEFAULT_WIDTH)
                    .attr("height", LABEL2.DEFAULT_HEIGHT)
            } else if (card.typeId == 5) {
                var _rect = _gCard.datum(card).append("image")
                    .attr("href", "/resources/image/components/label_02/label_05.svg")
                    .attr("width", LABEL2.DEFAULT_WIDTH)
                    .attr("height", LABEL2.DEFAULT_HEIGHT)
            } else if (card.typeId == 6) {
                var _rect = _gCard.datum(card).append("image")
                    .attr("href", "/resources/image/components/label_02/label_06.svg")
                    .attr("width", LABEL2.DEFAULT_WIDTH)
                    .attr("height", LABEL2.DEFAULT_HEIGHT)
            } else if (card.typeId == 7) {
                var _rect = _gCard.datum(card).append("image")
                    .attr("href", "/resources/image/components/label_02/label_07.svg")
                    .attr("width", LABEL2.DEFAULT_WIDTH)
                    .attr("height", LABEL2.DEFAULT_HEIGHT)
            } else if (card.typeId == 8) {
                var _rect = _gCard.datum(card).append("image")
                    .attr("href", "/resources/image/components/label_02/label_08.svg")
                    .attr("width", LABEL2.DEFAULT_WIDTH)
                    .attr("height", LABEL2.DEFAULT_HEIGHT)
            }
            
            var _deviceDescription = _gCard.datum(card).append("text")
            .attr("x", "80")
            .attr("y", "10")
            .attr("fill", "black")
            .attr("font-size", "15")
    ...
    draw: function (card) {
        ...
        var _cardTopMaker = _gCard.datum(card).append('circle')
            .attr("id", function (d) { return LABEL2.ID_CONNECT_TOP_MARKER + d.id; })
            ...
            .attr("opacity", 0)
            .attr("cursor", "pointer")
            .attr("marker", LABEL2.ID_CONNECT_TOP_MARKER)
            .attr("fill", "#276cb8")
            .call(LABEL2.connect);

        var _cardRightMaker = _gCard.datum(card).append('circle')
            .attr("id", function (d) { return LABEL2.ID_CONNECT_RIGHT_MARKER + d.id; })
            .attr("class", "circle-connect")
            .attr("r", "7")
            .attr("transform", "translate(0,0)")
            .attr("cx", function (d) { return d.width; })
            .attr("cy", function (d) { return d.height / 2; })
            .attr("opacity", 0)
            .attr("cursor", "pointer")
            .attr("marker", LABEL2.ID_CONNECT_RIGHT_MARKER)
            .attr("fill", "#276cb8")
            .call(LABEL2.connect);

        var _cardBottomMaker = _gCard.datum(card).append('circle')
            .attr("id", function (d) { return LABEL2.ID_CONNECT_BOTTOM_MARKER + d.id; })
            .attr("class", "circle-connect")
            .attr("r", "7")
            .attr("transform", "translate(0,0)")
            .attr("cx", function (d) { return d.width / 2; })
            ...
            .attr("opacity", 0)
            .attr("cursor", "pointer")
            .attr("marker", LABEL2.ID_CONNECT_BOTTOM_MARKER)
            .attr("fill", "#276cb8")
            .call(LABEL2.connect);

        var _cardLeftMaker = _gCard.datum(card).append('circle')
            .attr("id", function (d) { return LABEL2.ID_CONNECT_LEFT_MARKER + d.id; })
            .attr("class", "circle-connect")
            .attr("r", "7")
            .attr("transform", "translate(0,0)")
            .attr("cx", 0)
            ...
            .attr("opacity", 0)
            .attr("cursor", "pointer")
            .attr("marker", LABEL2.ID_CONNECT_LEFT_MARKER)
            .attr("fill", "#276cb8")
            .call(LABEL2.connect);

        var _gX = _gCard.datum(card).append("g")
            .attr("id", function (d) { return (LABEL2.ID_REMOVE + d.id); })
            .attr("transform", "translate(-20 , -40)")
            .attr("opacity", "0")
            .attr("cursor", "pointer")
            .on("click", LABEL2.delete);
    ...
    drag: d3.drag()
        .on("start", function (i, d) {
            ...
            var _oCard = LABEL2.get(d.id);
            document.getElementById("label" + _oCard.typeId + "-description").value = _oCard.description;
        ...
        .on("drag", function (i, d) {
            var _gCard = d3.select("g[id=" + LABEL2.ID + d.id + "]");
            var _circleTopMaker = d3.select("circle[id=" + LABEL2.ID_CONNECT_TOP_MARKER + d.id + "]");
            var _circleBottomMaker = d3.select("circle[id=" + LABEL2.ID_CONNECT_BOTTOM_MARKER + d.id + "]");
            var _circleLeftMaker = d3.select("circle[id=" + LABEL2.ID_CONNECT_LEFT_MARKER + d.id + "]");
            var _circleRightMaker = d3.select("circle[id=" + LABEL2.ID_CONNECT_RIGHT_MARKER + d.id + "]");

            d3.select(this).attr("transform", "translate(" + (d.x) + "," + (d.y) + ")");
            d.x = i.x;
            d.y = i.y;
            LABEL2.moveArrows(d.id);
            ...
            if (g_connect.cardId == "") {
                d3.selectAll("circle[id^=" + METER.ID_CIRCLE_CONNECT + "]").each(function (c) {
                    ...
                    if (_isOverlapT || _isOverlapB || _isOverlapL || _isOverlapR) {
                        ...
                        if (_isOverlapT) {
                            g_connect.circleFrom = LABEL2.ID_CONNECT_TOP_MARKER;
                        } else if (_isOverlapB) {
                            g_connect.circleFrom = LABEL2.ID_CONNECT_BOTTOM_MARKER;
                        } else if (_isOverlapL) {
                            g_connect.circleFrom = LABEL2.ID_CONNECT_LEFT_MARKER;
                        } else if (_isOverlapR) {
                            g_connect.circleFrom = LABEL2.ID_CONNECT_RIGHT_MARKER;
                        }
                    };
                });
    ...
    connect: d3.drag()
        .on("start", function (i, d) {
            ...
            var _oCard = LABEL2.get(d.id);
            document.getElementById("label" + d.typeId + "-description").value = _oCard.description;
            ...
            if (Number(_oCard.labelType) == 1) {
                document.getElementById("label-type-01").checked = true;
            } else {
                document.getElementById("label-type-02").checked = true;
            };
            ...
            var _gArrow = g_svg.datum(LABEL2.directArrow).append('g')
            ...
            var _arrowLine = _gArrow.datum(LABEL2.directArrow).append("line")
            ...
            var _arrowStartPoint = _gArrow.datum(LABEL2.directArrow).append('circle')
            ...
            var _arrowEndPoint = _gArrow.datum(LABEL2.directArrow).append('circle')
        ...
        .on("drag", function (event, d) {
            ...
            var _gArrow = d3.select("g[id=" + ARROW.ID + LABEL2.directArrow.id + "]");
            var _arrowLine = d3.select("line[id=" + ARROW.ID_LINE + LABEL2.directArrow.id + "]");
            var _arrowEndPoint = d3.select("circle[id=" + ARROW.ID_LINE_POINT_END + LABEL2.directArrow.id + "]");
        ...
        .on("end", function (i, d) {
            ...
            if (g_connect.attachFlag && g_connect.id != "") {
                ...
                LABEL2.directArrow.to = g_connect.id;
                LABEL2.directArrow.toMarker = g_connect.attachMarker;
                LABEL2.directArrow.x2 = _x;
                LABEL2.directArrow.y2 = _y;
                DATA.aArrows.push(LABEL2.directArrow);
                ARROW.update(LABEL2.directArrow.id, 1);
            } else {
                d3.select("g[id=" + ARROW.ID + LABEL2.directArrow.id + "]").remove();
            }
    ...
    remove: function (id) {
        ...
        if (!isMarker) {
            d3.select("g[id=" + LABEL2.ID + id + "]").remove();
    ...
    focus: function (id) {
        if (id != null) {
            $('circle[id^=' + LABEL2.ID_CONNECT_TOP_MARKER + id + ']').attr("opacity", 1);
            $('circle[id^=' + LABEL2.ID_CONNECT_BOTTOM_MARKER + id + ']').attr("opacity", 1);
            $('circle[id^=' + LABEL2.ID_CONNECT_LEFT_MARKER + id + ']').attr("opacity", 1);
            $('circle[id^=' + LABEL2.ID_CONNECT_RIGHT_MARKER + id + ']').attr("opacity", 1);
            $('g[id^=' + LABEL2.ID_ROTATE + id + ']').attr("opacity", 1);
            $('g[id^=' + LABEL2.ID_REMOVE + id + ']').attr("opacity", 1);
        }
    },

    outFocus: function (id) {
        if (id != null) {
            $('circle[id^=' + LABEL2.ID_CONNECT_TOP_MARKER + id + ']').attr("opacity", 0);
            $('circle[id^=' + LABEL2.ID_CONNECT_BOTTOM_MARKER + id + ']').attr("opacity", 0);
            $('circle[id^=' + LABEL2.ID_CONNECT_LEFT_MARKER + id + ']').attr("opacity", 0);
            $('circle[id^=' + LABEL2.ID_CONNECT_RIGHT_MARKER + id + ']').attr("opacity", 0);
            $('g[id^=' + LABEL2.ID_ROTATE + id + ']').attr("opacity", 0);
            $('g[id^=' + LABEL2.ID_REMOVE + id + ']').attr("opacity", 0);
        } else {
            $('circle[id^=' + LABEL2.ID_CONNECT_TOP_MARKER + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('circle[id^=' + LABEL2.ID_CONNECT_BOTTOM_MARKER + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('circle[id^=' + LABEL2.ID_CONNECT_LEFT_MARKER + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('circle[id^=' + LABEL2.ID_CONNECT_RIGHT_MARKER + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('g[id^=' + LABEL2.ID_ROTATE + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('g[id^=' + LABEL2.ID_REMOVE + ']').each(function () {
                $(this).attr("opacity", 0);
            });
        }
    },
    ...
    moveArrows: function (id) {
        ...
        $.each(_attachArrows, function (i, data) {
            ...
            var _gCard = d3.select("g[id=" + LABEL2.ID + id + "]");
    ...
    update: function (id) {
        var _oCurrent = LABEL2.get(id);

        if (typeof _oCurrent !== "undefined" && _oCurrent.type == ("label" + _oCurrent.typeId)) {
            var _description = document.getElementById("label" + _oCurrent.typeId + "-description").value;
            var _oCard = {};
            _oCard = {
                "id": _oCurrent.id,
                "description": _description,
                "width": _oCurrent.width,
                "height": _oCurrent.height,
                "x": _oCurrent.x,
                "y": _oCurrent.y,
                "type": _oCurrent.type,
                "typeId": _oCurrent.typeId,
            }
            d3.select("g[id=" + LABEL2.ID + id + "]").remove();
