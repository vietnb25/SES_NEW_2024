...
let SGMV = {
    ID: "idgmv-",
    ID_CIRCLE_CONNECT: "gmvc",
    ID_CONNECT_TOP_MARKER: "gmvct-",
    ID_CONNECT_BOTTOM_MARKER: "gmvcb-",
    ID_STATUS_SGMV: "sigmv-",
    ID_PATH_SGMV: "pigmv-",
    ID_REMOVE: "gmvrm",
    ID_DETAIL: "idtgmv-",
    ID_FOCUS: "ifmgv-",

    SGMV_TOTAL_TEXT: "Tổng",
    SGMV_U_TEXT: "U (V)",
    SGMV_I_TEXT: "I (A)",
    SGMV_P_TEXT: "P (kW)",
    SGMV_T_TEXT: "T (°C)",
    ...
    ID_SGMV_TOTAL_VALUE_U: "igtvu-",
    ID_SGMV_TOTAL_VALUE_I: "igtvi-",
    ID_SGMV_TOTAL_VALUE_P: "igtvp-",
    ID_SGMV_TOTAL_VALUE_T: "igtvt-",
    ID_SGMV_N1_VALUE_U: "ign1vu-",
    ID_SGMV_N1_VALUE_I: "ign1vi-",
    ID_SGMV_N1_VALUE_P: "ign1vp-",
    ID_SGMV_N1_VALUE_T: "ign1vt-",
    ID_SGMV_N2_VALUE_U: "ign2vu-",
    ID_SGMV_N2_VALUE_I: "ign2vi-",
    ID_SGMV_N2_VALUE_P: "ign2vp-",
    ID_SGMV_N2_VALUE_T: "ign2vt-",
    ID_SGMV_N3_VALUE_U: "ign3vu-",
    ID_SGMV_N3_VALUE_I: "ign3vi-",
    ID_SGMV_N3_VALUE_P: "ign3vp-",
    ID_SGMV_N3_VALUE_T: "ign3vt-",
    ID_SGMV_N4_VALUE_U: "ign4vu-",
    ID_SGMV_N4_VALUE_I: "ign4vi-",
    ID_SGMV_N4_VALUE_P: "ign4vp-",
    ID_SGMV_N4_VALUE_T: "ign4vt-",
    ID_SGMV_N5_VALUE_U: "ign5vu-",
    ID_SGMV_N5_VALUE_I: "ign5vi-",
    ID_SGMV_N5_VALUE_P: "ign5vp-",
    ID_SGMV_N5_VALUE_T: "ign5vt-",
    ID_SGMV_N6_VALUE_U: "ign6vu-",
    ID_SGMV_N6_VALUE_I: "ign6vi-",
    ID_SGMV_N6_VALUE_P: "ign6vp-",
    ID_SGMV_N6_VALUE_T: "ign6vt-",
    ID_SGMV_N7_VALUE_U: "ign7vu-",
    ID_SGMV_N7_VALUE_I: "ign7vi-",
    ID_SGMV_N7_VALUE_P: "ign7vp-",
    ID_SGMV_N7_VALUE_T: "ign7vt-",
    ID_SGMV_N8_VALUE_U: "ign8vu-",
    ID_SGMV_N8_VALUE_I: "ign8vi-",
    ID_SGMV_N8_VALUE_P: "ign8vp-",
    ID_SGMV_N8_VALUE_T: "ign8vt-",

    directArrow: {},

    collect: function () {
        var _tagName = document.getElementById("sgmv-tag-name").value;
        var _deviceName = document.getElementById("sgmv-device-name").value;
        var _description = document.getElementById("sgmv-description").value;
        var _deviceCaculator = Number($("input[name=sgmv_caculator]").filter(":checked").val());
    ...
    drawLoad: function (card) {
        ...
        var _gCard = g_svg.datum(card).append('g')
            .attr("id", function (d) { return (SGMV.ID + d.id); })
        ...
        var _path1 = _gCard.datum(card).append("path")
            .attr("id", function (d) { return (SGMV.ID_PATH_SGMV + d.deviceId); })
            .attr("d", CONSTANTS.SGMV.path1)
        ...
        var _gDeviceName = _gCard.datum(card).append('g')
            .attr("transform", "translate(300,36)");
        ...
        var _textT = _gCard.datum(card).append("text")
            ...
            .attr("text-anchor", "middle")
            .attr("font-size", "15")
            .text(SGMV.SGMV_T_TEXT);

        var _textTotal = _gCard.datum(card).append("text")
            .attr("x", "197")
            .attr("y", "86")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
            .attr("text-anchor", "middle")
            .attr("font-size", "15")
            .text(SGMV.SGMV_TOTAL_TEXT);

        var _valueTotalU = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_TOTAL_VALUE_U + d.deviceId); })
            .attr("x", "197")
            .attr("y", "116")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueTotalI = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_TOTAL_VALUE_I + d.deviceId); })
            .attr("x", "197")
            .attr("y", "146")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueTotalP = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_TOTAL_VALUE_P + d.deviceId); })
            .attr("x", "197")
            .attr("y", "172")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueTotalT = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_TOTAL_VALUE_T + d.deviceId); })
            .attr("x", "197")
            .attr("y", "200")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _textN1 = _gCard.datum(card).append("text")
            .attr("x", "267")
            .attr("y", "86")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
            .attr("text-anchor", "middle")
            .attr("font-size", "15")
            .text(SGMV.SGMV_N1_TEXT);

        var _valueU1 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N1_VALUE_U + d.deviceId); })
            .attr("x", "267")
            .attr("y", "116")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueI1 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N1_VALUE_I + d.deviceId); })
            .attr("x", "267")
            .attr("y", "146")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueP1 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N1_VALUE_P + d.deviceId); })
            .attr("x", "267")
            .attr("y", "172")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueT1 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N1_VALUE_T + d.deviceId); })
            .attr("x", "267")
            .attr("y", "200")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _textN2 = _gCard.datum(card).append("text")
            .attr("x", "336")
            .attr("y", "86")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
            .attr("text-anchor", "middle")
            .attr("font-size", "15")
            .text(SGMV.SGMV_N2_TEXT);

        var _valueU2 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N2_VALUE_U + d.deviceId); })
            .attr("x", "336")
            .attr("y", "116")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueI2 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N2_VALUE_I + d.deviceId); })
            .attr("x", "336")
            .attr("y", "146")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueP2 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N2_VALUE_P + d.deviceId); })
            .attr("x", "336")
            .attr("y", "172")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueT2 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N2_VALUE_T + d.deviceId); })
            .attr("x", "336")
            .attr("y", "200")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _textN3 = _gCard.datum(card).append("text")
            .attr("x", "406")
            .attr("y", "86")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
            .attr("text-anchor", "middle")
            .attr("font-size", "15")
            .text(SGMV.SGMV_N3_TEXT);

        var _valueU3 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N3_VALUE_U + d.deviceId); })
            .attr("x", "406")
            .attr("y", "116")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueI3 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N3_VALUE_I + d.deviceId); })
            .attr("x", "406")
            .attr("y", "146")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueP3 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N3_VALUE_P + d.deviceId); })
            .attr("x", "406")
            .attr("y", "172")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueT3 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N3_VALUE_T + d.deviceId); })
            .attr("x", "406")
            .attr("y", "200")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _textN4 = _gCard.datum(card).append("text")
            .attr("x", "477")
            .attr("y", "86")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
            .attr("text-anchor", "middle")
            .attr("font-size", "15")
            .text(SGMV.SGMV_N4_TEXT);

        var _valueU4 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N4_VALUE_U + d.deviceId); })
            .attr("x", "477")
            .attr("y", "116")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueI4 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N4_VALUE_I + d.deviceId); })
            .attr("x", "477")
            .attr("y", "146")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueP4 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N4_VALUE_P + d.deviceId); })
            .attr("x", "477")
            .attr("y", "172")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueT4 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N4_VALUE_T + d.deviceId); })
            .attr("x", "477")
            .attr("y", "200")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _textN5 = _gCard.datum(card).append("text")
            .attr("x", "548")
            .attr("y", "86")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
            .attr("text-anchor", "middle")
            .attr("font-size", "15")
            .text(SGMV.SGMV_N5_TEXT);

        var _valueU5 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N5_VALUE_U + d.deviceId); })
            .attr("x", "548")
            .attr("y", "116")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueI5 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N5_VALUE_I + d.deviceId); })
            .attr("x", "548")
            .attr("y", "146")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueP5 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N5_VALUE_P + d.deviceId); })
            .attr("x", "548")
            .attr("y", "172")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueT5 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N5_VALUE_T + d.deviceId); })
            .attr("x", "548")
            .attr("y", "200")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _textN6 = _gCard.datum(card).append("text")
            .attr("x", "620")
            .attr("y", "86")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
            .attr("text-anchor", "middle")
            .attr("font-size", "15")
            .text(SGMV.SGMV_N6_TEXT);

        var _valueU6 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N6_VALUE_U + d.deviceId); })
            .attr("x", "620")
            .attr("y", "116")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueI6 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N6_VALUE_I + d.deviceId); })
            .attr("x", "620")
            .attr("y", "146")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueP6 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N6_VALUE_P + d.deviceId); })
            .attr("x", "620")
            .attr("y", "172")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueT6 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N6_VALUE_T + d.deviceId); })
            .attr("x", "620")
            .attr("y", "200")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _textN7 = _gCard.datum(card).append("text")
            .attr("x", "685")
            .attr("y", "86")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
            .attr("text-anchor", "middle")
            .attr("font-size", "15")
            .text(SGMV.SGMV_N7_TEXT);

        var _valueU7 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N7_VALUE_U + d.deviceId); })
            .attr("x", "685")
            .attr("y", "116")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueI7 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N7_VALUE_I + d.deviceId); })
            .attr("x", "685")
            .attr("y", "146")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueP7 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N7_VALUE_P + d.deviceId); })
            .attr("x", "685")
            .attr("y", "172")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueT7 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N7_VALUE_T + d.deviceId); })
            .attr("x", "685")
            .attr("y", "200")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _textN8 = _gCard.datum(card).append("text")
            .attr("x", "755")
            .attr("y", "86")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
            .attr("text-anchor", "middle")
            .attr("font-size", "15")
            .text(SGMV.SGMV_N8_TEXT);

        var _valueU8 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N8_VALUE_U + d.deviceId); })
            .attr("x", "755")
            .attr("y", "116")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueI8 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N8_VALUE_I + d.deviceId); })
            .attr("x", "755")
            .attr("y", "146")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueP8 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N8_VALUE_P + d.deviceId); })
            .attr("x", "755")
            .attr("y", "172")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _valueT8 = _gCard.datum(card).append("text")
            .attr("id", function (d) { return (SGMV.ID_SGMV_N8_VALUE_T + d.deviceId); })
            .attr("x", "755")
            .attr("y", "200")
            .attr("fill", "black")
            .attr("dominant-baseline", "middle")
        ...
        var _rect = _gCard.datum(card).append("rect")
            .attr("id", function (d) { return (SGMV.ID_FOCUS + d.id); })
            .attr("x", "-20")
            .attr("y", "-20")
            .attr("width", "840")
            .attr("height", "260")
    ...
    draw: function (card) {
        ...
        var _cardTopMaker = _gCard.datum(card).append('circle')
            .attr("id", function (d) { return SGMV.ID_CONNECT_TOP_MARKER + d.id; })
            ...
            .attr("opacity", 0)
            .attr("cursor", "pointer")
            .attr("marker", SGMV.ID_CONNECT_TOP_MARKER)
            .attr("fill", "#237ba0")
            .call(SGMV.connect);

        var _cardBottomMaker = _gCard.datum(card).append('circle')
            .attr("id", function (d) { return SGMV.ID_CONNECT_BOTTOM_MARKER + d.id; })
            .attr("class", "circle-connect")
            .attr("r", "7")
            .attr("transform", "translate(0,0)")
            .attr("cx", 26.5)
            ...
            .attr("opacity", 0)
            .attr("cursor", "pointer")
            .attr("marker", SGMV.ID_CONNECT_BOTTOM_MARKER)
            .attr("fill", "#237ba0")
            .call(SGMV.connect);

        var _gX = _gCard.datum(card).append("g")
            .attr("id", function (d) { return (SGMV.ID_REMOVE + d.id); })
            .attr("transform", "translate(-20,-40)")
            .attr("opacity", "0")
            .attr("cursor", "pointer")
            .on("click", SGMV.delete);
    ...
    drag: d3.drag()
        .on("start", function (i, d) {
            ...
            var _oCard = SGMV.get(d.id);
            document.getElementById("sgmv-device-name").value = _oCard.deviceName;
            document.getElementById("sgmv-tag-name").value = _oCard.tagName;
            document.getElementById("sgmv-description").value = _oCard.description;

            if (Number(_oCard.caculator) == 1) {
                document.getElementById("sgmv-caculator-1").checked = true;
            } else {
                document.getElementById("sgmv-caculator-0").checked = true;
            };
        ...
        .on("drag", function (i, d) {
            var _gCard = d3.select("g[id=" + SGMV.ID + d.id + "]");
            var _circleTopMaker = d3.select("circle[id=" + SGMV.ID_CONNECT_TOP_MARKER + d.id + "]");
            var _circleBottomMaker = d3.select("circle[id=" + SGMV.ID_CONNECT_BOTTOM_MARKER + d.id + "]");

            d3.select(this).attr("transform", "translate(" + (d.x) + "," + (d.y) + ")");
            d.x = i.x;
            d.y = i.y;
            SGMV.moveArrows(d.id);
            ...
            if (g_connect.cardId == "") {
                d3.selectAll("circle[id^=" + METER.ID_CIRCLE_CONNECT + "]").each(function (c) {
                    ...
                    if (_isOverlapT || _isOverlapB) {
                        ...
                        if (_isOverlapT) {
                            g_connect.circleFrom = SGMV.ID_CONNECT_TOP_MARKER;
                        } else if (_isOverlapB) {
                            g_connect.circleFrom = SGMV.ID_CONNECT_BOTTOM_MARKER;
                        };
                    };
                });
    ...
    connect: d3.drag()
        .on("start", function (i, d) {
            ...
            var _gArrow = g_svg.datum(SGMV.directArrow).append('g')
            ...
            var _arrowLine = _gArrow.datum(SGMV.directArrow).append("line")
            ...
            var _arrowStartPoint = _gArrow.datum(SGMV.directArrow).append('circle')
            ...
            var _arrowEndPoint = _gArrow.datum(SGMV.directArrow).append('circle')
        ...
        .on("drag", function (event, d) {
            ...
            var _gArrow = d3.select("g[id=" + ARROW.ID + SGMV.directArrow.id + "]");
            var _arrowLine = d3.select("line[id=" + ARROW.ID_LINE + SGMV.directArrow.id + "]");
            var _arrowEndPoint = d3.select("circle[id=" + ARROW.ID_LINE_POINT_END + SGMV.directArrow.id + "]");
        ...
        .on("end", function (i, d) {
            ...
            if (g_connect.attachFlag && g_connect.id != "") {
                ...
                SGMV.directArrow.to = g_connect.id;
                SGMV.directArrow.toMarker = g_connect.attachMarker;
                SGMV.directArrow.x2 = _x;
                SGMV.directArrow.y2 = _y;
                DATA.aArrows.push(SGMV.directArrow);
                ARROW.update(SGMV.directArrow.id, 1);
            } else {
                d3.select("g[id=" + ARROW.ID + SGMV.directArrow.id + "]").remove();
            }
    ...
    remove: function (id) {
        ...
        if (!isMarker) {
            var sgmvIndex = DATA.aCards.findIndex(x => x.id === id);
            $("#sgmvIds").append(new Option(DATA.aCards[sgmvIndex].deviceName, DATA.aCards[sgmvIndex].deviceId));

            d3.select("g[id=" + SGMV.ID + id + "]").remove();
    ...
    focus: function (id) {
        if (id != null) {
            $('circle[id^=' + SGMV.ID_CONNECT_TOP_MARKER + id + ']').attr("opacity", 1);
            $('circle[id^=' + SGMV.ID_CONNECT_BOTTOM_MARKER + id + ']').attr("opacity", 1);
            $('g[id^=' + SGMV.ID_REMOVE + id + ']').attr("opacity", 1);
        }
    },

    outFocus: function (id) {
        if (id != null) {
            $('circle[id^=' + SGMV.ID_CONNECT_TOP_MARKER + id + ']').attr("opacity", 0);
            $('circle[id^=' + SGMV.ID_CONNECT_BOTTOM_MARKER + id + ']').attr("opacity", 0);
            $('g[id^=' + SGMV.ID_REMOVE + id + ']').attr("opacity", 0)
        } else {
            $('circle[id^=' + SGMV.ID_CONNECT_TOP_MARKER + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('circle[id^=' + SGMV.ID_CONNECT_BOTTOM_MARKER + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('g[id^=' + SGMV.ID_REMOVE + ']').each(function () {
                $(this).attr("opacity", 0);
            });
        }
    },
    ...
    moveArrows: function (id) {
        ...
        $.each(_attachArrows, function (i, data) {
            ...
            var _gCard = d3.select("g[id=" + SGMV.ID + id + "]");
    ...
    update: function (id) {
        ...
        var _oCurrent = SGMV.get(id);

        if (typeof _oCurrent !== "undefined" && _oCurrent.type == "sgmv") {
            var _deviceCaculator = Number($("input[name=sgmv_caculator]").filter(":checked").val());
            var _tagName = document.getElementById("sgmv-tag-name").value;
            var _description = document.getElementById("sgmv-description").value;
            var _oCard = {
