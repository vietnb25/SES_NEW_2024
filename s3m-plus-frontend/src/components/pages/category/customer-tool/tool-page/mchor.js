...
let MCHOR = {
    ...
    DEFAULT_X: 20,
    DEFAULT_Y: 20,
    ID_CIRCLE_CONNECT: "mhicc",
    ID_CONNECT_TOP_MARKER: "mhicct-",
    ID_CONNECT_BOTTOM_MARKER: "mhiccr-",
    ...
    drawLoad: function (card) {
        ...
        var _gCard = g_svg.datum(card).append('g')
            .attr("id", function (d) { return (MCHOR.ID + d.id); })
        ...
        if (card.typeMC == "1") {
            var _circle1 = _gCard.datum(card).append("circle")
                .attr("cx", MCHOR.CIRCLE_X)
                .attr("cy", MCHOR.CIRCLE_Y)
                .attr("r", MCHOR.CIRCLE_RADIUS)
            ...
            var _arrowSwitch = _gCard.datum(card).append("path")
                .attr("d", "M 0 41 l 12 12 l 2 -2 l 1 6 l -6 -1 l 2 -2 l -12 -12")
    ...
    draw: function (card) {
        ...
        var _circleTopMaker = _gCard.datum(card).append('circle')
            .attr("id", function (d) { return MCHOR.ID_CONNECT_TOP_MARKER + d.id; })
            ...
            .attr("opacity", 0)
            .attr("cursor", "pointer")
            .attr("marker", MCHOR.ID_CONNECT_TOP_MARKER)
            .attr("fill", "#276cb8")
            .call(MCHOR.connect);

        var _circleBottomMaker = _gCard.datum(card).append('circle')
            .attr("id", function (d) { return MCHOR.ID_CONNECT_BOTTOM_MARKER + d.id; })
            .attr("class", "circle-connect")
            .attr("r", "7")
            ...
            .attr("opacity", 0)
            .attr("cursor", "pointer")
            .attr("marker", MCHOR.ID_CONNECT_BOTTOM_MARKER)
            .attr("fill", "#276cb8")
            .call(MCHOR.connect);

        var _gRotate = _gCard.datum(card).append('g')
            .attr("id", function (d) { return (MCHOR.ID_ROTATE + d.id); })
            .attr("transform", "translate(83,-25)")
            .attr("class", "rotate")
            .attr("opacity", "0")
            .on("click", MCHOR.rotate);
        ...
        var _gX = _gCard.datum(card).append("g")
            .attr("id", function (d) { return (MCHOR.ID_REMOVE + d.id); })
            .attr("transform", "translate(-20,-40)")
            .attr("opacity", "0")
            .attr("cursor", "pointer")
            .on("click", MCHOR.delete);
    ...
    drag: d3.drag()
        .on("start", function (i, d) {
            ...
            document.getElementById("mccb-horizontal").checked = true;
        ...
        .on("drag", function (i, d) {
            var _gCard = d3.select("g[id=" + MCHOR.ID + d.id + "]");
            var _circleTopMaker = d3.select("circle[id=" + MCHOR.ID_CONNECT_TOP_MARKER + d.id + "]");
            var _circleBottomMaker = d3.select("circle[id=" + MCHOR.ID_CONNECT_BOTTOM_MARKER + d.id + "]");

            d3.select(this).attr("transform", "translate(" + (d.x) + "," + (d.y) + ")");
            d.x = i.x;
            d.y = i.y;
            MCHOR.moveArrows(d.id);
            ...
            if (g_connect.cardId == "") {
                d3.selectAll("circle[id^=" + METER.ID_CIRCLE_CONNECT + "]").each(function (c) {
                    ...
                    if (_isOverlapT || _isOverlapB) {
                        ...
                        if (_isOverlapT) {
                            g_connect.circleFrom = MCHOR.ID_CONNECT_TOP_MARKER;
                        } else if (_isOverlapB) {
                            g_connect.circleFrom = MCHOR.ID_CONNECT_BOTTOM_MARKER;
                        }
    ...
    connect: d3.drag()
        .on("start", function (i, d) {
            ...
            var _gArrow = g_svg.datum(MCHOR.directArrow).append('g')
            ...
            var _arrowLine = _gArrow.datum(MCHOR.directArrow).append("line")
            ...
            var _arrowStartPoint = _gArrow.datum(MCHOR.directArrow).append('circle')
            ...
            var _arrowEndPoint = _gArrow.datum(MCHOR.directArrow).append('circle')
        ...
        .on("drag", function (event, d) {
            ...
            var _gArrow = d3.select("g[id=" + ARROW.ID + MCHOR.directArrow.id + "]");
            var _arrowLine = d3.select("line[id=" + ARROW.ID_LINE + MCHOR.directArrow.id + "]");
            var _arrowEndPoint = d3.select("circle[id=" + ARROW.ID_LINE_POINT_END + MCHOR.directArrow.id + "]");
        ...
        .on("end", function (i, d) {
            ...
            if (g_connect.attachFlag && g_connect.id != "") {
                ...
                MCHOR.directArrow.to = g_connect.id;
                MCHOR.directArrow.toMarker = g_connect.attachMarker;
                MCHOR.directArrow.x2 = _x;
                MCHOR.directArrow.y2 = _y;
                DATA.aArrows.push(MCHOR.directArrow);
                ARROW.update(MCHOR.directArrow.id, 1);
            } else {
                d3.select("g[id=" + ARROW.ID + MCHOR.directArrow.id + "]").remove();
            }
    ...
    focus: function (id) {
        if (id != null) {
            $('circle[id^=' + MCHOR.ID_CONNECT_TOP_MARKER + id + ']').attr("opacity", 1);
            $('circle[id^=' + MCHOR.ID_CONNECT_BOTTOM_MARKER + id + ']').attr("opacity", 1);
            $('g[id^=' + MCHOR.ID_ROTATE + id + ']').attr("opacity", 1);
            $('g[id^=' + MCHOR.ID_REMOVE + id + ']').attr("opacity", 1);
        }
    },

    outFocus: function (id) {
        if (id != null) {
            $('circle[id^=' + MCHOR.ID_CONNECT_TOP_MARKER + id + ']').attr("opacity", 0);
            $('circle[id^=' + MCHOR.ID_CONNECT_BOTTOM_MARKER + id + ']').attr("opacity", 0);
            $('g[id^=' + MCHOR.ID_ROTATE + id + ']').attr("opacity", 0);
        } else {
            $('circle[id^=' + MCHOR.ID_CONNECT_TOP_MARKER + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('circle[id^=' + MCHOR.ID_CONNECT_BOTTOM_MARKER + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('g[id^=' + MCHOR.ID_ROTATE + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('g[id^=' + MCHOR.ID_REMOVE + ']').each(function () {
                $(this).attr("opacity", 0);
            });
        }
    },
    ...
    moveArrows: function (id) {
        ...
        $.each(_attachArrows, function (i, data) {
            ...
            var _gCard = d3.select("g[id=" + MCHOR.ID + id + "]");
    ...
    rotate: function (e, d) {
        ...
        if (!isMarker) {
            ...
            d3.select("g[id=" + MCHOR.ID + d.id + "]").remove();
