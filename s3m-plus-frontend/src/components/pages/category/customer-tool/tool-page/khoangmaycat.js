...
let KHOANGMAYCAT = {
    ID: "idkhgmc-",
    ID_CIRCLE_CONNECT: "khgmcc",
    ID_CONNECT_TOP_MARKER: "khgmcct-",
    ID_CONNECT_LEFT_MARKER: "khgmccl-",
    ID_CONNECT_RIGHT_MARKER: "khgmccr-",
    ID_CONNECT_BOTTOM_MARKER: "khgmccb-",

    ID_STATUS_KHOANGMAYCAT: "iskhgmc-",
    ID_PATH_1_KHOANGMAYCAT: "ip1khgmc-",
    ID_PATH_2_KHOANGMAYCAT: "ip2khgmc-",
    ID_REMOVE: "irmkhgmc-",
    ID_DETAIL: "idtkhgmc-",
    ID_FOCUS: "ifkhgmc-",

    KHOANGMAYCAT_T_TEXT: "T (°C)",
    KHOANGMAYCAT_H_TEXT: "H (%)",
    KHOANGMAYCAT_P_TEXT: "PD",

    ID_KHOANGMAYCAT_VALUE_T: "ivtkhgmc-",
    ID_KHOANGMAYCAT_VALUE_H: "ivhkhgmc-",
    ID_KHOANGMAYCAT_VALUE_P: "ivpkhgmc-",
    ...
    collect: function () {
        var _tagName = document.getElementById("khoang-may-cat-tag-name").value;
        var _deviceName = document.getElementById("khoang-may-cat-device-name").value;
        var _description = document.getElementById("khoang-may-cat-description").value;
        var _deviceCaculator = Number($("input[name=khoang_may_cat_caculator]").filter(":checked").val());
        ...
        return _khoangmaycat;
    },

    create: function () {
        var _oCard = KHOANGMAYCAT.collect();
        DATA.aCards.push(_oCard);
        KHOANGMAYCAT.draw(_oCard);
    },
    ...
    drawLoad: function (card) {
        ...
        var _gCard = g_svg.datum(card).append('g')
            .attr("id", function (d) { return (KHOANGMAYCAT.ID + d.id); })
        ...
        if (card.rmuType == 1) {
            var _path1 = _gCard.datum(card).append("path")
                .attr("id", function (d) { return (KHOANGMAYCAT.ID_PATH_1_KHOANGMAYCAT + d.deviceId); })
                .attr("d", CONSTANTS.KHOANGMAYCAT1.path1)
            ...
            var _path2 = _gCard.datum(card).append("path")
                ...
                .attr("d", CONSTANTS.KHOANGMAYCAT1.path2)
                .attr("style", "stroke:none;fill-rule:evenodd;fill:rgb(4.705882%,13.72549%,14.117647%);fill-opacity:1;");
        } else if (card.rmuType == 2) {
            var _path1 = _gCard.datum(card).append("path")
                .attr("id", function (d) { return (KHOANGMAYCAT.ID_PATH_1_KHOANGMAYCAT + d.deviceId); })
                .attr("d", CONSTANTS.KHOANGMAYCAT2.path1)
                .attr("style", "stroke:none;fill-rule:evenodd;fill:rgb(4.705882%,13.72549%,14.117647%);fill-opacity:1;");

            var _path2 = _gCard.datum(card).append("path")
                .attr("id", function (d) { return (KHOANGMAYCAT.ID_PATH_2_KHOANGMAYCAT + d.deviceId); })
                .attr("d", CONSTANTS.KHOANGMAYCAT2.path2)
                .attr("style", "stroke:none;fill-rule:evenodd;fill:rgb(4.705882%,13.72549%,14.117647%);fill-opacity:1;");
        } else if (card.rmuType == 3) {
            var _path1 = _gCard.datum(card).append("path")
                .attr("id", function (d) { return (KHOANGMAYCAT.ID_PATH_1_KHOANGMAYCAT + d.deviceId); })
                .attr("d", CONSTANTS.KHOANGMAYCAT3.path1)
                .attr("style", "stroke:none;fill-rule:evenodd;fill:rgb(4.705882%,13.72549%,14.117647%);fill-opacity:1;");
        ...
        var _textT = _gCard.datum(card).append("text")
            ...
            .attr("text-anchor", "middle")
            .attr("font-size", "15")
            .text(KHOANGMAYCAT.KHOANGMAYCAT_T_TEXT);
        ...
        var _textH = _gCard.datum(card).append("text")
            ...
            .attr("text-anchor", "middle")
            .attr("font-size", "15")
            .text(KHOANGMAYCAT.KHOANGMAYCAT_H_TEXT);
        ...
        var _textP = _gCard.datum(card).append("text")
            ...
            .attr("text-anchor", "middle")
            .attr("font-size", "15")
            .text(KHOANGMAYCAT.KHOANGMAYCAT_P_TEXT);
        ...
        var _rect = _gCard.datum(card).append("rect")
            .attr("id", function (d) { return (KHOANGMAYCAT.ID_FOCUS + d.id); })
            .attr("x", "-30")
            .attr("y", "-30")
            .attr("width", "238")
            .attr("height", "238")
            .attr("fill", "transparent")
            .on("click", KHOANGMAYCAT.detail);
    ...
    draw: function (card) {
        ...
        var _gCard = g_svg.datum(card).append('g')
            ...
            .on("click", KHOANGMAYCAT.select)
            .call(KHOANGMAYCAT.drag);
        ...
        var _cardTopMaker = _gCard.datum(card).append('circle')
            .attr("id", function (d) { return KHOANGMAYCAT.ID_CONNECT_TOP_MARKER + d.id; })
            ...
            .attr("opacity", 0.5)
            .attr("cursor", "pointer")
            .attr("marker", KHOANGMAYCAT.ID_CONNECT_TOP_MARKER)
            .attr("fill", "#237ba0")
            .call(KHOANGMAYCAT.connect);

        var _cardBottomMaker = _gCard.datum(card).append('circle')
            .attr("id", function (d) { return KHOANGMAYCAT.ID_CONNECT_BOTTOM_MARKER + d.id; })
            .attr("class", "circle-connect")
            .attr("r", "7")
            .attr("transform", "translate(0,0)")
            .attr("cx", 52.9)
            ...
            .attr("opacity", 0.5)
            .attr("cursor", "pointer")
            .attr("marker", KHOANGMAYCAT.ID_CONNECT_BOTTOM_MARKER)
            .attr("fill", "#237ba0")
            .call(KHOANGMAYCAT.connect);

        var _gX = _gCard.datum(card).append("g")
            .attr("id", function (d) { return (KHOANGMAYCAT.ID_REMOVE + d.id); })
            .attr("transform", "translate(-20,-40)")
            .attr("opacity", "1")
            .attr("cursor", "pointer")
            .on("click", KHOANGMAYCAT.delete);
    ...
    drag: d3.drag()
        .on("start", function (i, d) {
            ...
            var _oCard = KHOANGMAYCAT.get(d.id);
            document.getElementById("khoang-may-cat-device-name").value = _oCard.deviceName;
            document.getElementById("khoang-may-cat-tag-name").value = _oCard.tagName;
            document.getElementById("khoang-may-cat-description").value = _oCard.description;

            if (Number(_oCard.caculator) == 1) {
                document.getElementById("khoang-may-cat-caculator-1").checked = true;
            } else {
                document.getElementById("khoang-may-cat-caculator-0").checked = true;
            };
        ...
        .on("drag", function (i, d) {
            var _gCard = d3.select("g[id=" + KHOANGMAYCAT.ID + d.id + "]");
            var _circleTopMaker = d3.select("circle[id=" + KHOANGMAYCAT.ID_CONNECT_TOP_MARKER + d.id + "]");
            var _circleBottomMaker = d3.select("circle[id=" + KHOANGMAYCAT.ID_CONNECT_BOTTOM_MARKER + d.id + "]");

            d3.select(this).attr("transform", "translate(" + (d.x) + "," + (d.y) + ")");
            d.x = i.x;
            d.y = i.y;
            KHOANGMAYCAT.moveArrows(d.id);
            ...
            if (g_connect.cardId == "") {
                d3.selectAll("circle[id^=" + METER.ID_CIRCLE_CONNECT + "]").each(function (c) {
                    ...
                    if (_isOverlapT || _isOverlapB) {
                        ...
                        if (_isOverlapT) {
                            g_connect.circleFrom = KHOANGMAYCAT.ID_CONNECT_TOP_MARKER;
                        } else if (_isOverlapB) {
                            g_connect.circleFrom = KHOANGMAYCAT.ID_CONNECT_BOTTOM_MARKER;
                        };
                    };
                });
    ...
    connect: d3.drag()
        .on("start", function (i, d) {
            ...
            var _gArrow = g_svg.datum(KHOANGMAYCAT.directArrow).append('g')
            ...
            var _arrowLine = _gArrow.datum(KHOANGMAYCAT.directArrow).append("line")
            ...
            var _arrowStartPoint = _gArrow.datum(KHOANGMAYCAT.directArrow).append('circle')
            ...
            var _arrowEndPoint = _gArrow.datum(KHOANGMAYCAT.directArrow).append('circle')
        ...
        .on("drag", function (event, d) {
            ...
            var _gArrow = d3.select("g[id=" + ARROW.ID + KHOANGMAYCAT.directArrow.id + "]");
            var _arrowLine = d3.select("line[id=" + ARROW.ID_LINE + KHOANGMAYCAT.directArrow.id + "]");
            var _arrowEndPoint = d3.select("circle[id=" + ARROW.ID_LINE_POINT_END + KHOANGMAYCAT.directArrow.id + "]");
        ...
        .on("end", function (i, d) {
            ...
            if (g_connect.attachFlag && g_connect.id != "") {
                ...
                KHOANGMAYCAT.directArrow.to = g_connect.id;
                KHOANGMAYCAT.directArrow.toMarker = g_connect.attachMarker;
                KHOANGMAYCAT.directArrow.x2 = _x;
                KHOANGMAYCAT.directArrow.y2 = _y;
                DATA.aArrows.push(KHOANGMAYCAT.directArrow);
                ARROW.update(KHOANGMAYCAT.directArrow.id, 1);
            } else {
                d3.select("g[id=" + ARROW.ID + KHOANGMAYCAT.directArrow.id + "]").remove();
            }
    ...
    remove: function (id) {
        ...
        if (!isMarker) {
            ...
            d3.select("g[id=" + KHOANGMAYCAT.ID + id + "]").remove();
    ...
    focus: function (id) {
        if (id != null) {
            $('circle[id^=' + KHOANGMAYCAT.ID_CONNECT_TOP_MARKER + id + ']').attr("opacity", 1);
            $('circle[id^=' + KHOANGMAYCAT.ID_CONNECT_BOTTOM_MARKER + id + ']').attr("opacity", 1);
            $('g[id^=' + KHOANGMAYCAT.ID_REMOVE + id + ']').attr("opacity", 1);
        }
    },

    outFocus: function (id) {
        if (id != null) {
            $('circle[id^=' + KHOANGMAYCAT.ID_CONNECT_TOP_MARKER + id + ']').attr("opacity", 0);
            $('circle[id^=' + KHOANGMAYCAT.ID_CONNECT_BOTTOM_MARKER + id + ']').attr("opacity", 0);
            $('g[id^=' + KHOANGMAYCAT.ID_REMOVE + id + ']').attr("opacity", 0)
        } else {
            $('circle[id^=' + KHOANGMAYCAT.ID_CONNECT_TOP_MARKER + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('circle[id^=' + KHOANGMAYCAT.ID_CONNECT_BOTTOM_MARKER + ']').each(function () {
                $(this).attr("opacity", 0);
            });
            $('g[id^=' + KHOANGMAYCAT.ID_REMOVE + ']').each(function () {
                $(this).attr("opacity", 0);
            });
        }
    },
    ...
    moveArrows: function (id) {
        ...
        $.each(_attachArrows, function (i, data) {
            ...
            var _gCard = d3.select("g[id=" + KHOANGMAYCAT.ID + id + "]");
    ...
    update: function (id) {
        var _oCurrent = KHOANGMAYCAT.get(id);

        if (typeof _oCurrent !== "undefined" && _oCurrent.type == "khoangmaycat") {
