...
@NoArgsConstructor
@AllArgsConstructor
public class OperationRmuDrawerResponse {
    ...
    public OperationRmuDrawerResponse(final DataRmuDrawer1 rmuDrawer1) {
        this.id = rmuDrawer1.getId();
        this.deviceId = rmuDrawer1.getDeviceId();
        this.deviceName = rmuDrawer1.getDeviceName();
        ...
        this.sentDate = rmuDrawer1.getSentDate();
