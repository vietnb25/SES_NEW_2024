...
public class OverviewPowerServiceImpl implements OverviewPowerService {
     ...
     */
    @Override
    public OverviewPVPower getPower(final Map<String, Object> condition) {
    ...
    @Override
    public OverviewPVPower getLayer(Map<String, Object> condition) {
        return overviewPowerMapper.getLayerPV(condition);
    }

    @Override
    public Integer getDeviceHasWarning(Map<String, Object> condition) {
        return overviewPowerMapper.getDeviceHasWarning(condition);
    }
