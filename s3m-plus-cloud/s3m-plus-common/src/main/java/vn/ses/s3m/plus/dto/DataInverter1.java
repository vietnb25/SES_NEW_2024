...
@Data
public class DataInverter1 implements Comparable<DataInverter1> {
     ...
     */
    @Override
    public int compareTo(final DataInverter1 inverter) {

        return this.sentDate.compareTo(inverter.getSentDate());
    }
